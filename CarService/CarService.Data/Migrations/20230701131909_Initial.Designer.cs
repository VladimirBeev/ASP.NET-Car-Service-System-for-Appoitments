...
namespace CarService.Migrations
{
    ...
    [Migration("20230701131909_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarService.Data.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarService.Data.Models.CarOwner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarService.Data.Models.CarsService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarService.Data.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarService.Data.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CarService.Data.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("CarService.Data.Models.CarsService", "CarService")
                        .WithMany("Appointments")
                        .HasForeignKey("CarServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CarService.Data.Models.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("CarService.Data.Models.Car", b =>
                {
                    b.HasOne("CarService.Data.Models.CarOwner", "Owner")
                        .WithMany("Car")
            ...
            modelBuilder.Entity("CarService.Data.Models.CarsService", b =>
                {
                    b.HasOne("CarService.Data.Models.Payment", null)
            ...
            modelBuilder.Entity("CarService.Data.Models.Payment", b =>
                {
                    b.HasOne("CarService.Data.Models.CarOwner", "CarOwner")
                        .WithMany()
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
